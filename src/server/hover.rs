...
/// not have hover data.
pub fn lookup_hover(token: &str) -> Option<&'static str> {
    match token {
        // Sections
        ...
        "<CLIFF_GENERATION>" => Some(include_str!(
            "../../hover_docs/sections/cliff-generation.md"
        )),
        "<TERRAIN_GENERATION>" => Some(include_str!(
            "../../hover_docs/sections/terrain-generation.md"
        )),
        "<CONNECTION_GENERATION>" => Some(include_str!(
            "../../hover_docs/sections/connection-generation.md"
        )),
        "<OBJECTS_GENERATION>" => Some(include_str!(
            "../../hover_docs/sections/objects-generation.md"
        )),
        // Commands
        "random_placement" => Some(include_str!(
            "../../hover_docs/commands/random-placement.md"
        )),
        "direct_placement" => Some(include_str!(
            "../../hover_docs/commands/direct-placement.md"
        )),
        ...
        "force_nomad_treaty" => Some(include_str!(
            "../../hover_docs/commands/force-nomad-treaty.md"
        )),
        "behavior_version" => Some(include_str!(
            "../../hover_docs/commands/behavior-version.md"
        )),
        "override_map_size" => Some(include_str!(
            "../../hover_docs/commands/override-map-size.md"
        )),
        "set_gaia_civilization" => Some(include_str!(
            "../../hover_docs/commands/set-gaia-civilization.md"
        )),
        "ai_info_map_type" => Some(include_str!(
            "../../hover_docs/commands/ai-info-map-type.md"
        )),
        ...
        "water_definition" => Some(include_str!(
            "../../hover_docs/commands/water-definition.md"
        )),
        ...
        "create_elevation" => Some(include_str!(
            "../../hover_docs/commands/create-elevation.md"
        )),
        "color_correction" => Some(include_str!(
            "../../hover_docs/commands/color-correction.md"
        )),
        ...
        "create_actor_area" => Some(include_str!(
            "../../hover_docs/commands/create-actor-area.md"
        )),
        ...
        "number_of_tiles" => Some(include_str!(
            "../../hover_docs/attributes/number-of-tiles.md"
        )),
        ...
        "border_fuzziness" => Some(include_str!(
            "../../hover_docs/attributes/border-fuzziness.md"
        )),
        "clumping_factor" => Some(include_str!(
            "../../hover_docs/attributes/clumping-factor.md"
        )),
        "land_conformity" => Some(include_str!(
            "../../hover_docs/attributes/land-conformity.md"
        )),
        "base_elevation" => Some(include_str!(
            "../../hover_docs/attributes/base-elevation.md"
        )),
        "assign_to_player" => Some(include_str!(
            "../../hover_docs/attributes/assign-to-player.md"
        )),
        "assign_to" => Some(include_str!("../../hover_docs/attributes/assign-to.md")),
        "zone" => Some(include_str!("../../hover_docs/attributes/zone.md")),
        "set_zone_by_team" => Some(include_str!(
            "../../hover_docs/attributes/set-zone-by-team.md"
        )),
        ...
        "number_of_clumps" => Some(include_str!(
            "../../hover_docs/attributes/number-of-clumps.md"
        )),
        ...
        "replace_terrain" => Some(include_str!(
            "../../hover_docs/attributes/replace-terrain.md"
        )),
        ...
        "number_of_groups" => Some(include_str!(
            "../../hover_docs/attributes/number-of-groups.md"
        )),
        "group_variance" => Some(include_str!(
            "../../hover_docs/attributes/group-variance.md"
        )),
        ...
        "resource_delta" => Some(include_str!(
            "../../hover_docs/attributes/resource-delta.md"
        )),
        ...
        "avoid_cliff_zone" => Some(include_str!(
            "../../hover_docs/attributes/avoid-cliff-zone.md"
        )),
        ...
        "force_placement" => Some(include_str!(
            "../../hover_docs/attributes/force-placement.md"
        )),
        ...
        "avoid_actor_area" => Some(include_str!(
            "../../hover_docs/attributes/avoid-actor-area.md"
        )),
        ...
        "match_player_civ" => Some(include_str!(
            "../../hover_docs/attributes/match-player-civ.md"
        )),
        ...
        "#include_drs" => Some(include_str!("../../hover_docs/keywords/include-drs.md")),
